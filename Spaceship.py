...
def draw(canvas):
    ...
    # scores and lifes
    pos = 40
    canvas.draw_text("Lives: " + str(lives), (WIDTH - 120, pos), 25, "Red")
    canvas.draw_text("Score: " + str(score), (WIDTH - 120, pos + 40), 25, "Red")
...
a_rock = Sprite([WIDTH / 3, HEIGHT / 3], [0.3, 0.3], 0, 0.02, asteroid_image, asteroid_info)
...
#http://www.codeskulptor.org/#user15_XD6RWOXvD6BvPOy.py